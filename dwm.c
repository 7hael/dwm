...
enum { SchemeNorm, SchemeSel, SchemeStatus, SchemeTagsSel, SchemeTagsNorm, SchemeTabActive, SchemeTabInactive, SchemeInfoSel, SchemeInfoNorm, SchemeWarn, SchemeUrgent }; /* color schemes */
